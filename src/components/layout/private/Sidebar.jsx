...
export const Sidebar = () => {
  return (
    ...
    <header className="aside__header">
        <h1 className="aside__title">Hola, Dennys Gabriel</h1>
    </header>
        ...
        <div className="aside__profile-info">
            ...
            <div className="profile-info__general-info">
                ...
                <div className="general-info__container-names">
                    <a href="#" className="container-names__name">Dennys Gabriel</a>
                    <p className="container-names__nickname">ProAlarm Web</p>
                </div>
            </div>
